...
An experimental 2d version of Broken Seals.

It is on an early tech demo level. It uses Terraman 2D for it's terrain. It still needs some work, and mob spawning still need to be 
re-enabled.
...
You can get binaries under the releases tab [here](https://github.com/Relintai/broken_seals_2d/releases).\
You can also try a live version running in the browser [here](https://relintai.github.io/broken_seals_2d/).
...
![Broken Seals 2D](pictures/screen.png)
...
The [/game](https://github.com/Relintai/broken_seals_2d/tree/master/game) folder contains the game's code and assets.
...
This is the [module](https://github.com/Relintai/broken_seals_2d/blob/master/game/modules/entity_classes/naturalist/game_module.tres) for the naturalist, and it's [ResourceDB](https://github.com/Relintai/broken_seals_2d/blob/master/game/modules/entity_classes/naturalist/resource_db.tres), which will be merged into a central resource db for ESS. 
...
Now if you look at the [HEADS file](https://github.com/Relintai/broken_seals_2d/blob/master/HEADS).
